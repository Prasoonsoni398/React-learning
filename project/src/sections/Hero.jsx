    ...
    <>
      <div className={`${darkMode ? "dark bg-black" : "light bg-white"}`}>
        ...
        >
          ...
          <p data-aos="zoom-in" className="text-white sm:text-xl text-md lg:pr-125 pr-0 ">
      ...
      >
        ...
        >
            <div className="w-full">
                ...
                <input type="text" placeholder="Enter an address, state, city or pincode" className="bg-white p-2 w-full mt-2 border-b border-[#c9c7c1] outline-none focus:border-amber-400"/>
            </div>
            <div className="w-full">
                <h1 className="text-black font-semibold dark:text-white">TYPE</h1>
                <select name="selectOption" id="selectOption" className="bg-white p-2 border-b w-full border-[#c9c7c1] outline-none text-gray-500 text-md mt-2">
            ...
            <div className="w-full">
                ...
                <select name="selectOption" id="selectOption" className="bg-white p-2 border-b w-full border-[#c9c7c1] outline-none  text-gray-500 text-md mt-2">
                    ...
                    <option value="Option2" className="active:bg-amber-200" >Duplex</option>
